...
questions about software quality, (e.g., "How much can we trust
a software after testing it?"), and automatic test generation
(e.g., What fraction of possible faults can it detect?").
...
We manually classified 1016 live mutants obtained by running %the
existing test suites and compared the predictions from statistical estimators to the result.
