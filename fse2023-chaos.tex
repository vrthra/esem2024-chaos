...
$$
\text{killable mutants} = \text{total mutants} - \text{equivalent mutants}
$$
\end{tcolorbox}
...
as covering a structural element is a prerequisite for detecting any mutation in that element.  Hence, one may ask; is this approach of using the frequency count of known elements to estimate unknown elements applicable to mutation analysis?
...
and their fully evaluation using mutation analysis result-
