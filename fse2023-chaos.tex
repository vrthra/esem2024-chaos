...
Let $\mathcal{P}$ be the program under test and $\mathcal{D}$ the set of all tests $X_n$ that exercise $\mathcal{P}$.
% can exercise.
We can model a testing campaign $\mathcal{T}$%is modeled
