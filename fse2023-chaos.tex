...
been used, mutation analysis can provide a more reliable answer
% than structural coverage
with its ability to induce and evaluate all possible
...
Statistical frequency based estimators for unknown software species have been
recently proposed for estimating \emph{reachable coverage} during fuzzing.
Given the closeness of mutation analysis to coverage, one may ask, can
the frequency based estimators used for coverage base used for estimating the
number of killable mutants?

This paper investigates this hypothesis and presents the results of a large-scale empirical study
on the application of \estimatorCount widely known frequency based
statistical estimators for estimating the number of detectable mutants in
...
We found that the estimators considered
lack sufficient predictive power to be useful to the practitioners,
and the prediction is program and test suite dependent.
