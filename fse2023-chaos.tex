...
% ALESSIO: Dirty trick to keep the first page as it was before
%\newpage
...
as a general framework capable of estimating the unseen software
elements that fulfill a property when only a fraction has been discovered.
...
The idea is that the relative frequency of observation of software elements such as covered
structural elements, observed defects etc. contains information about the number of similar
software elements of the same kind that is yet to be observed.
