...
Let $\mathcal{P}$ be the program under test and $\mathcal{D}$ the set of all tests $\mathcal{P}$ can exercise.
A testing campaign is modeled as a stochastic process
\[
...
\]
Integrating out all possible values of $\left\{\nu_1, \nu_2,\cdots,\nu_T \right\}$, we obtain the unconditional marginal distribution for the incidence-based frequency $Y_i$ for the mutant $i$,
