...
mutants is program-specific~\cite{offutt1994using,grun2009impact}, adding high variability to standard estimation techniques~\cite{gotelli2011estimating}.
...
%
To study whether such frequency analysis based statistical models can estimate the number
...
summarizes the main findings of our study. The
replication package is available
...
mutants as \Evosuite testsuites are free of manual bias. % of test case selection.
...
We next examine the basic ideas behind population size, or species richness, estimation
...
(1) they divide the area into numerous \emph{segments},
