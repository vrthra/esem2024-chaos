...
Mutation analysis is the premier technique for evaluating software test suite
quality and estimating residual software defects. However, the reliability of 
mutation analysis is hampered by the so called \emph{equivalent mutants} which
are undetectable by any test case.
...
can provide an accurate estimate for the number of killable mutants.

\noindent\textbf{Method.}
We conducted a large-scale empirical study
on the ability of \estimatorCount widely known frequency-based
statistical models to estimate the number of killable mutants in
...
Our results suggest that the considered statistical estimators lack sufficient
predictive power and cannot produce reliable or useful estimates of killable
mutants. We further find that the \emph{bootstrap} method was the best
performing method out of all methods considered.
\end{abstract}
