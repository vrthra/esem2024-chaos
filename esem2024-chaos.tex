...
statistical estimators ($E$) and the manual classification ($E^M$) as: ${|E - E^M|}$. 
%
...
Notably, we removed any invalid estimate before computing MD.
We consider invalid any estimate that resulted in negative
CI upper bound, negative point estimate, or a value higher than the total number of possible mutants.
%
