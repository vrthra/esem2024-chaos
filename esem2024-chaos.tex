...
(ii) in most of the cases, the statistical estimators were significantly different than manual estimates (CI Overlaps $\le 3$) despite 
(iii) they resulted is bounded mean differences (MD $\in (5, 20)$).
%
...
in light of these results, we can answer RQ1 as follows:
\begin{tcolorbox}[boxrule=0.5pt, arc=4pt, boxsep=0pt, width=\columnwidth]
