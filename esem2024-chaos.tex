...
\EvosuiteRandom (results in \Cref{tbl:estrandom}) and \EvosuiteDynamosa (\Cref{tbl:estdynamosa}).
...
This is a tantalizing hint because the number of total generated mutants is
not part of the estimator equations. Hence, it is likely that the observed
pattern is linked to the total killable mutants which is close to the total
generated mutants.
...
While there are several other enticing patterns in the data (see Appendix~\cite{replication-package}), the data we have
