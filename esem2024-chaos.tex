...
difference between the point estimate $E$ and manual classification estimate $ME$
normalized by the total number of mutants, i.e., $\frac{E - ME}{S}$ ($\times$
...
The \emph{Mean} column shows the mean difference, and \emph{Stdev} shows the standard deviation in this estimate.
