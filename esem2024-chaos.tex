...
\newcommand{\RQBx}{%
\begin{description}\item[] \textcircled{2} \textbf{Are frequency-based estimators affected by sampling strategies?}\end{description}}

\newcommand{\RQCx}{%
\begin{description}\item[] \textcircled{3} \textbf{Are frequency-based estimators affected by sampling units?}\end{description}}
