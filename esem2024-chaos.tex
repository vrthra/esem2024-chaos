...
\begin{subfigure}{.49\textwidth}
    \centering
      \includegraphics[width=0.95\linewidth]{plots_for_rahul/3/Chao-organic.pdf}
\vspace*{-3mm}
\caption{Chao organic}
\end{subfigure}
\hfill
\begin{subfigure}{.49\textwidth}
    \centering
      \includegraphics[width=0.95\linewidth]{plots_for_rahul/3/Chao-dynamosa.pdf}
\vspace*{-3mm}
\caption{Chao organic}
\end{subfigure}
%\begin{subfigure}{.49\textwidth}
