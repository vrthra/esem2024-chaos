...
\caption{Killable mutants estimated by species richness estimators. Comparison with ground truth. The method based estimators are in blue, while class based estimators are in red. The purple is the manual sampling based estimate (ground truth).}
\end{figure}
...
\end{subfigure}
\label{fig:groundtruth}
\caption{Killable mutants estimated by species richness estimators. Comparison with methods as sampling unit.}
\end{figure*}
...
\end{subfigure}
\label{fig:groundtruth}
\caption{Killable mutants estimated by species richness estimators. Comparison with classes as sampling unit.}
\end{figure*}
