...
\caption{Killable mutants estimated by species richness estimators, comparison with ground truth.
  The method based estimators are in {\color{blue}{blue}}, while class based estimators are in {\color{red}{red}}.
The purple is the manual sampling based estimate (ground truth).}
\end{figure}
