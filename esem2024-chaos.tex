...
a change that mutant's behavior when compared to the original program.
...
mutants killed by test cases. %That is, 
...
the estimates from \Evosuite to match the estimates from manually classified live
