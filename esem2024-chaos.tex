...
estimating reachable coverage in the STADS framework~\cite{bohme2018stads}.
...
In the next section, we introduce the underlying statistical model,
which is used for the statistical estimators we considered.
