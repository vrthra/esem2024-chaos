...
\vspaceboxedtext{%[boxrule=0.5pt, arc=4pt, boxsep=0pt, width=\columnwidth]
...
estimators on each of the test suites. We first performed estimation %estimated the
%killable units
...
\resizebox{\columnwidth}{!}{%
   % \rowcolors{1}{white}{yellow}
    \begin{tabular}{|r|l|r|r|r|r|r|}
        \hline
        Id & Estimator & Valid Est. & CI Overlaps & MD (\%) & Stdev (\%) \\
        \hline
\rowcolor{yellow}
...
or the (bad) results achieved in \RQA were a statistical fluke---which would
