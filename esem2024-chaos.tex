...
% Quotes with emphasis is probably a bit too much. We typically
% use either quotes or emphasis for importance.
...
estimation of residual risk after a testing campaign. However,
a way to reliably estimate killable mutants has remained out of reach.
...
techniques.
This paper investigates the following question. \emph{Can
the species richness estimation methods provide an accurate
estimate to this question?}
