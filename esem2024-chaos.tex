...
\begin{description}
  \item[\RQC] \textbf{Are frequency based estimators affected by sampling units?}% class and unit
\end{description}
...
We investigated this in \textbf{\RQC.}
...
\noindent\RQA\textbf{What is the accuracy of frequency based estimators in predicting killable mutants?}\\
...
\noindent\RQA\textbf{How accurate are frequency based estimators in predicting
    killable mutants?}\\
...
\noindent\textbf{\RQC. Are frequency based estimators affected by sampling units?}\\
