...
estimators often (but not always) appear to provide an underestimate compared to
...
generated mutants. However, the uncertainties in CI increase drastically as the
...
diminish as the number of killed mutants approaches the total generated mutants.
...
While there are several other interesting patterns in the data (see Appendix~\cite{replication-package}), the data we have
...
We also found tantalizing evidence that may indicate that statistical estimation
may be possible with more sophisticated models or more data. Further study is
