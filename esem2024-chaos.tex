...
\begin{subfigure}{\textwidth}
      \includegraphics[width=0.5\textwidth]{chaoplots/3/Chao-organic.pdf}
\vspace*{-3mm}
\caption{\Chao \original}
\label{fig:groundtruth1}
\end{subfigure}
%\hfill
\begin{subfigure}{\textwidth}
      \includegraphics[width=0.5\textwidth,trim=0cm 0cm 0cm 0cm, clip=true]{chaoplots/3/Chao-dynamosa.pdf}
\vspace*{-3mm}
\caption{\Chao \EvosuiteDynamosa}
\label{fig:groundtruth2}
\end{subfigure}
\begin{subfigure}{\textwidth}
      \includegraphics[width=0.5\textwidth,trim=0cm 0cm 0cm 0cm, clip=true]{chaoplots/3/Chao-random.pdf}
\vspace*{-3mm}
\caption{\Chao \EvosuiteRandom}
\label{fig:groundtruth3}
\end{subfigure}
\label{fig:groundtruth}
  \newcommand{\colorpurple}{163, 124, 194}
  \definecolor{cgroundtruth}{RGB}{163,124,194}
  \definecolor{cmethod}{RGB}{0,108,168}
  \definecolor{cclass}{RGB}{219,36,42}
\caption{Killable mutants estimated by species richness estimators, comparison with ground truth.
The x-axis is the percentage of mutants, with 1.0 indicating the complete set of generated mutants.
  ...
  percentage of killed mutants, which is the absolute lower-bound.}
\end{figure}
...
\end{subfigure}
\label{fig:groundtruth}
  \caption{Comparison with \textbf{methods} as sampling unit.
  The \original is {\color{darkgreen}{green}}, 
  \EvosuiteDynamosa is
  {\color{blue}{blue}}, and \EvosuiteRandom is {\color{red}{red}}.}
\end{figure*}
...
\end{subfigure}
\label{fig:groundtruth}
  \caption{Comparison with \textbf{classes} as sampling unit.
  The \original is {\color{darkgreen}{green}}, 
  \EvosuiteDynamosa is {\color{blue}{blue}},
  and \EvosuiteRandom is {\color{red}{red}}.}
