...
\noindent\textbf{Aims.}
Recently, leveraging frequency based species estimation methods
has been proposed for solving similar problems in software testing.
While promising, there has been no comprehensive study on whether
any such such frequency based species estimation methods can
