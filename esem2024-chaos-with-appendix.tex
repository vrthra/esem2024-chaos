...
mutants killed by test cases. That is, we count the number of mutants killed
by a single test case, those killed by two test cases, and so on, and use this
...
while $S_{\textit{infreq}}$ is those that does not. % with incidence frequency no larger than $k$.
...
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-collections.pdf}
%        %\caption{1a}
%\end{subfigure}%
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-compress.pdf}
%        %\caption{1b}
%\end{subfigure}
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-configuration.pdf}
%        %\caption{1b}
%\end{subfigure}%
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-csv.pdf}
%        %\caption{1b}
%\end{subfigure}
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-dbcp.pdf}
%        %\caption{1b}
%\end{subfigure}%
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-imaging.pdf}
%        %\caption{1b}
%\end{subfigure}
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-io.pdf}
%        %\caption{1b}
%\end{subfigure}%
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-lang.pdf}
%        %\caption{1b}
%\end{subfigure}
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-math.pdf}
%        %\caption{1b}
%\end{subfigure}%
%\begin{subfigure}{.5\textwidth}
%    \centering
%      \includegraphics[width=0.9\linewidth]{charts-test/organic/commons-net.pdf}
%        %\caption{1b}
%\end{subfigure}
...
\onecolumn
    ...
    \section{Charts}
    \subsection{\original}
    \label{subsec:original-est}

    \begin{figure}[H]
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-collections-organic.pdf}
            %\caption{1a}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-compress-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-configuration-organic.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-csv-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-dbcp-organic.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-imaging-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-io-organic.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-lang-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-math-organic.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-net-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \caption{Estimators from test \original. The blue is from \emph{class test set} data, and red from \emph{method test set} data.
        Dotted black line corresponds to the number of killed mutants, dashed black line corresponds to the number of manually estimated
        killed mutants, dashed gray lines define the confidence interval of manual estimation.}
        \label{fig:originalest}
    \end{figure}
...
% by est
    \begin{figure}[H]
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Bootstrap-organic.pdf}
            %\caption{1a}
        \end{subfigure}%
        \begin{subfigure}{.49\textwidth}
            \centering
            \includegraphics[width=0.93\linewidth]{charts/estimators/Zelterman-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Chao-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.49\textwidth}
            \centering
            \includegraphics[width=0.92\linewidth]{charts/estimators/iChao-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ChaoBunge-organic.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-1-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-organic.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-k0-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Jackknife-organic.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/PCG-organic.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Pnpmle-organic.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Unpmle-organic.pdf}
            %\caption{1b}
        \end{subfigure}

        \caption{
            Killable mutants estimated by %frequency estimators for
            various estimator from test \original and manual sampling (i.e., ground truth).
            Ratio of mutants in x-axis, with 1.0 indicating all generated mutants. The y-axis lists the projects.
            The method based estimators are in \textcolor{cmethod}{blue}, while class based estimators are in \textcolor{cclass}{red}.
            The \textcolor{cgroundtruth}{purple} band is the manual sampling based estimate CI, %(ground truth),
            with dark purple line the point estimate.
            The dotted black line indicates the total
            ratio of killed mutants, which is the absolute lower-bound.
        }
        \label{fig:originalestkill}
    \end{figure}
% end by est
    \clearpage
    \subsection{\EvosuiteRandom}
    \label{subsec:random-est}

    \begin{figure}[H]
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-collections-random.pdf}
            %\caption{1a}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-compress-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-configuration-random.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-csv-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-dbcp-random.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-imaging-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-io-random.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-lang-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-math-random.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-net-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \caption{Estimators from test \EvosuiteRandom. The blue is from \emph{class test set} data, and red from \emph{method test set} data.
        Dotted black line corresponds to the number of killed mutants, dashed black line corresponds to the number of manually estimated
        killed mutants, dashed gray lines define the confidence interval of manual estimation.}
        \label{fig:random-est}
    \end{figure}
\clearpage
% by est
    \begin{figure}[H]
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Bootstrap-random.pdf}
            %\caption{1a}
        \end{subfigure}%
        \begin{subfigure}{.49\textwidth}
            \centering
            \includegraphics[width=0.93\linewidth]{charts/estimators/Zelterman-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Chao-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.49\textwidth}
            \centering
            \includegraphics[width=0.92\linewidth]{charts/estimators/iChao-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ChaoBunge-random.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-1-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-random.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-k0-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Jackknife-random.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/PCG-random.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Pnpmle-random.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Unpmle-random.pdf}
            %\caption{1b}
        \end{subfigure}

        \caption{
            Killable mutants estimated by %frequency estimators for
            various estimator from test \EvosuiteRandom and manual sampling (i.e., ground truth).
            Ratio of mutants in x-axis, with 1.0 indicating all generated mutants. The y-axis lists the projects.
            The method based estimators are in \textcolor{cmethod}{blue}, while class based estimators are in \textcolor{cclass}{red}.
            The \textcolor{cgroundtruth}{purple} band is the manual sampling based estimate CI, %(ground truth),
            with dark purple line the point estimate.
        ...
        \label{fig:randomestkill}
    \end{figure}
% end by est
    \clearpage

    \subsection{\EvosuiteDynamosa}
    \label{subsec:dynamosa-est}

    \begin{figure}[H]
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-collections-dynamosa.pdf}
            %\caption{1a}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-compress-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-configuration-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-csv-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-dbcp-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-imaging-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-io-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-lang-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-math-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/subjects/commons-net-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \caption{Estimators from test \EvosuiteDynamosa. The blue is from \emph{class test set} data, and red from \emph{method test set} data.
        Dotted black line corresponds to the number of killed mutants, dashed black line corresponds to the number of manually estimated
        killed mutants, dashed gray lines define the confidence interval of manual estimation.}
        \label{fig:dynamosa-est}
    \end{figure}
\clearpage
% by est
    \begin{figure}[H]
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Bootstrap-dynamosa.pdf}
            %\caption{1a}
        \end{subfigure}%
        \begin{subfigure}{.49\textwidth}
            \centering
            \includegraphics[width=0.93\linewidth]{charts/estimators/Zelterman-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Chao-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.49\textwidth}
            \centering
            \includegraphics[width=0.92\linewidth]{charts/estimators/iChao-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ChaoBunge-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-1-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/ICE-k0-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Jackknife-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/PCG-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Pnpmle-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=0.9\linewidth]{charts/estimators/Unpmle-dynamosa.pdf}
            %\caption{1b}
        \end{subfigure}

        \caption{
            Killable mutants estimated by %frequency estimators for
            various estimator from test \EvosuiteDynamosa and manual sampling (i.e., ground truth).
            Ratio of mutants in x-axis, with 1.0 indicating all generated mutants. The y-axis lists the projects.
            The method based estimators are in \textcolor{cmethod}{blue}, while class based estimators are in \textcolor{cclass}{red}.
            The \textcolor{cgroundtruth}{purple} band is the manual sampling based estimate CI, %(ground truth),
            with dark purple line the point estimate.
...
\begin{table}[h]
\rowcolors{1}{white}{yellow}
\caption{Population proportion estimates of killable mutants with corresponding confidence intervals based on manual mutants classification.}
    \begin{tabular}{lrrrrr}
        ...
        commons-dbcp &           4230 &    1127 &     4229.9 &  4229.4 &  4230.0 \\
        commons-dbcp &           4230 &    4219 &     4229.9 &  4229.4 &  4230.0 \\
        commons-dbcp &           4230 &     829 &     4229.9 &  4229.4 &  4230.0 \\
...
%    \rowcolors{1}{white}{yellow}
    \begin{longtable}{ccccccccccccc}
        \caption{Estimates of killable mutants produced by frequency based estimators for each test suite and sampling unit (including overestimates). The estimates which failed to compute or resulted in negative value are denoted with dash symbol.} \label{tab:allest}\\
%        \multicolumn{1}{|c|}{\textbf{First column}} & \multicolumn{1}{c|}{\textbf{Second column}} & \multicolumn{1}{c|}{\textbf{Third column}} \\ \hline
        \toprule
        &         &   & \rot{commons-collections} & \rot{commons-compress} & \rot{commons-configuration} & \rot{commons-csv} & \rot{commons-dbcp} & \rot{commons-imaging} & \rot{commons-io} & \rot{commons-lang} & \rot{commons-math} & \rot{commons-net} \\
%        \endfirsthead
...
%        \endhead
%
%        \midrule \multicolumn{13}{|r|}{{Continued on next page}} \\ \hline
%        \endfoot
%        testsuite & type & estimator &                     &                  &                       &             &              &                 &            &              &              &             \\
        ...
        dynamosa & classes &       Chao &                9470 &             7402 &                  5407 &         817 &         4815 &           13648 &       3743 &        11797 &        21201 &        6330 \\
        dynamosa & methods &       Chao &               10577 &             5247 &                  2950 &         556 &         1630 &            6324 &       3680 &        12611 &        11265 &        2410 \\
        organic & classes &       Chao &               11195 &             7613 &                  6222 &         793 &         4219 &            8800 &       3674 &        30357 &        36208 &        5321 \\
        organic & methods &       Chao &                7830 &             6992 &                  6219 &         551 &         4219 &            8050 &       3247 &        13224 &        36219 &        3000 \\
        random & classes &       Chao &                9892 &             6780 &                  5110 &         526 &         3022 &           12629 &       7107 &        10711 &        47624 &        5206 \\
        random & methods &       Chao &                6020 &             4888 &                  3103 &         430 &         1181 &            7055 &       2448 &        12220 &        53814 &        2318 \\
        dynamosa & classes & Chao\_Bunge &               11381 &             9152 &                     - &        1291 &            - &               - &       3937 &        11948 &            - &           - \\
        dynamosa & methods & Chao\_Bunge &               13329 &             5402 &                  3161 &         600 &         1926 &            6703 &       4120 &        13052 &        15350 &        2552 \\
        organic & classes & Chao\_Bunge &                   - &             8072 &                  6223 &         892 &         4219 &           17326 &       4198 &            - &        36328 &           - \\
        organic & methods & Chao\_Bunge &                8463 &             7266 &                  6219 &         556 &         4219 &           11866 &       3249 &        29590 &        36279 &           - \\
        random & classes & Chao\_Bunge &                   - &            14904 &                     - &         615 &            - &               - &          - &        11329 &        66514 &           - \\
        random & methods & Chao\_Bunge &                7731 &             5255 &                  3423 &         448 &         2310 &            9540 &       2891 &        15136 &       119969 &        2943 \\
        dynamosa & classes &        ICE &               10624 &             7392 &                  5623 &         852 &         5197 &           15937 &       4096 &        12559 &        22529 &        8261 \\
        dynamosa & methods &        ICE &               10673 &             5279 &                  2963 &         560 &         1570 &            6296 &       3654 &        12772 &        11675 &        2403 \\
        organic & classes &        ICE &               12474 &             7573 &                  6224 &         731 &            - &            8967 &       3994 &        36531 &        36342 &        6996 \\
        organic & methods &        ICE &                7571 &             6974 &                  6219 &         550 &            - &            7599 &       3233 &        13555 &        36289 &        2965 \\
        random & classes &        ICE &               11097 &             7555 &                  5266 &         542 &         2606 &           15509 &       6814 &        11623 &        54354 &        6216 \\
        random & methods &        ICE &                6384 &             5027 &                  3027 &         428 &         1349 &            7260 &       2506 &        12761 &        58958 &        2453 \\
        dynamosa & classes &      ICE-1 &               11001 &             8005 &                  8166 &         996 &         8511 &           24108 &       4096 &        12559 &        32500 &       12594 \\
        dynamosa & methods &      ICE-1 &               11689 &             5365 &                  3074 &         582 &         1706 &            6533 &       3882 &        12967 &        12959 &        2490 \\
        organic & classes &      ICE-1 &               16046 &             7874 &                  6224 &         816 &            - &           10610 &       4108 &            - &        36342 &       12708 \\
        organic & methods &      ICE-1 &                7991 &             7147 &                  6219 &         555 &            - &            8703 &       3246 &        16172 &        36289 &        3825 \\
        random & classes &      ICE-1 &               15153 &             8879 &                  7751 &         589 &         4373 &           24302 &       9458 &        11623 &        59025 &        9688 \\
        random & methods &      ICE-1 &                6935 &             5168 &                  3211 &         440 &         1542 &            8061 &       2684 &        13770 &        70043 &        2654 \\
        dynamosa & classes &     ICE\_k0 &               15595 &             9690 &                  8965 &         908 &         6032 &           21896 &       4134 &        12619 &        51638 &       14117 \\
        dynamosa & methods &     ICE\_k0 &                   - &            10182 &                 11475 &         993 &        12086 &           11761 &       8331 &        35343 &        57720 &        5403 \\
        organic & classes &     ICE\_k0 &               21772 &             9176 &                  6256 &         784 &         4219 &           13163 &       4228 &            - &        37029 &        9181 \\
        organic & methods &     ICE\_k0 &                   - &             8770 &                  6223 &         739 &         4219 &           13666 &       4248 &            - &        40236 &        9384 \\
        random & classes &     ICE\_k0 &               20662 &             9990 &                  8022 &         564 &         2831 &           22759 &       8514 &        11701 &            - &           - \\
        random & methods &     ICE\_k0 &               21460 &            10975 &                  9646 &         597 &         2774 &           20023 &       4605 &        38573 &            - &       13869 \\
        dynamosa & classes &  Jackknife &               11181 &            12273 &                  7533 &        1266 &         5011 &           17272 &       4588 &        13796 &        29099 &        7479 \\
        dynamosa & methods &  Jackknife &               14911 &             7816 &                  3286 &         612 &         2895 &            7393 &       4688 &        13918 &        13409 &        2817 \\
        organic & classes &  Jackknife &               14387 &             8659 &                  6255 &        1096 &         4221 &           13612 &       4247 &        34140 &        36741 &        6379 \\
        organic & methods &  Jackknife &                9041 &             7554 &                  6220 &         580 &            - &            9828 &       3424 &        16654 &        36597 &        4313 \\
        random & classes &  Jackknife &               13668 &             8415 &                  7169 &         634 &         3660 &           16033 &       8106 &        12852 &        57062 &        6538 \\
        random & methods &  Jackknife &                6939 &             5506 &                  3924 &         470 &         1366 &            8943 &       2931 &        14575 &        65249 &        2660 \\
        dynamosa & classes &        PCG &               10556 &                - &                 13430 &        1021 &        10860 &           16032 &       4383 &        13736 &            - &        6754 \\
        dynamosa & methods &        PCG &               18643 &             6816 &                  3442 &         645 &         3988 &            7339 &       5189 &        12998 &        11695 &           - \\
        organic & classes &        PCG &               12095 &                - &                  6243 &           - &            - &           24329 &       3966 &            - &        37682 &        9485 \\
        organic & methods &        PCG &                8360 &                - &                     - &         558 &         4219 &            9049 &       3271 &            - &        36710 &        5707 \\
        random & classes &        PCG &               14293 &                - &                  9832 &         647 &            - &           14735 &          - &        12580 &        50402 &        5568 \\
        random & methods &        PCG &                6183 &             4944 &                  3565 &         428 &         1285 &            8004 &       2993 &        12791 &        55837 &        2385 \\
        dynamosa & classes &     Pnpmle &               18050 &            18275 &                  7484 &        1036 &         7330 &           15926 &       7214 &        13713 &        46235 &        6895 \\
        dynamosa & methods &     Pnpmle &               21707 &             5246 &                  3101 &         839 &         2511 &            6817 &       4346 &        12774 &        18061 &        4306 \\
        organic & classes &     Pnpmle &               18058 &            13316 &                  7970 &        1077 &            - &           19284 &       6952 &            - &        70356 &        7613 \\
        organic & methods &     Pnpmle &                8409 &             9979 &                  6220 &         562 &            - &            8905 &       4917 &        14486 &        36726 &        3935 \\
        random & classes &     Pnpmle &               12768 &            11207 &                  7382 &         654 &         4596 &           14708 &          - &        21872 &        50429 &        5640 \\
        random & methods &     Pnpmle &                6230 &             5543 &                  3674 &         430 &         1206 &            7929 &       2694 &        12804 &        56085 &        2403 \\
        dynamosa & classes &     Unpmle &               10550 &                - &                  9510 &        1049 &            - &           15950 &       4385 &        13741 &            - &        6902 \\
        dynamosa & methods &     Unpmle &                   - &                - &                  3095 &         582 &            - &            6810 &       4548 &        12772 &        11646 &        2237 \\
        organic & classes &     Unpmle &               12160 &             8234 &                  6244 &        1183 &            - &               - &       3966 &            - &        37698 &           - \\
        organic & methods &     Unpmle &                8406 &             7263 &                  6220 &         561 &         4219 &            8903 &       3291 &        14484 &        36726 &        6456 \\
        random & classes &     Unpmle &               23013 &             7120 &                     - &         657 &            - &           14730 &          - &        12583 &        50428 &        5643 \\
        random & methods &     Unpmle &                6229 &             5486 &                  3696 &         430 &         1204 &            7924 &       2631 &            - &        56083 &        2400 \\
        dynamosa & classes &  Zelterman &                9147 &             7944 &                  6414 &         921 &         5149 &           14555 &       3573 &        11376 &        23248 &        6551 \\
        dynamosa & methods &  Zelterman &               12282 &             5782 &                  3434 &         669 &         1944 &            7153 &       4219 &        13329 &        13003 &        2756 \\
        organic & classes &  Zelterman &               12181 &             8586 &                  6219 &        1018 &            - &           10064 &       3595 &        32918 &        36195 &        5731 \\
        organic & methods &  Zelterman &               10132 &             8558 &                  6219 &         619 &            - &           10563 &       3529 &        15810 &        36195 &        3575 \\
        random & classes &  Zelterman &               10756 &             7117 &                  6166 &         574 &         3496 &           13447 &       7596 &        10141 &        47616 &        5583 \\
        random & methods &  Zelterman &                6636 &             5203 &                  3873 &         521 &         1293 &            8037 &       2738 &        13318 &        60211 &        2582 \\
        dynamosa & classes &      iChao &                9470 &             7956 &                  5899 &         900 &         5276 &           14745 &       3743 &        11797 &        23695 &        7032 \\
        dynamosa & methods &      iChao &               11271 &             5305 &                  3058 &         572 &         1755 &            6594 &       3889 &        12890 &        11937 &        2509 \\
        organic & classes &      iChao &               12182 &             7945 &                  6222 &         838 &            - &            9634 &       3674 &        32914 &        36208 &        6248 \\
        organic & methods &      iChao &                8118 &             7170 &                  6219 &         560 &            - &            8471 &       3286 &        14082 &        36219 &        3259 \\
        random & classes &      iChao &               11019 &             7413 &                  5618 &         560 &         3351 &           13670 &       7858 &        10711 &        48073 &        5969 \\
        random & methods &      iChao &                6335 &             4936 &                  3254 &         432 &         1248 &            7520 &       2584 &        12931 &        57849 &        2435 \\
        \bottomrule
    \end{longtable}
%\end{table}
% end by est
